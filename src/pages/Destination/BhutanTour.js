      ...
      <div className="relative h-96 bg-cover bg-center" style={{ backgroundImage: 'url("https://source.unsplash.com/1600x900/?bhutan")' }}>
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="text-center text-white">
            <h1 className="text-6xl font-bold mb-4">Bhutan</h1>
            <h3 className="text-4xl  mb-2">Land of the Thunder Dragon</h3>
            <p className="text-lg">Explore the rich culture, stunning landscapes, and spiritual heritage of Bhutan.</p>
          </div>
        </div>
      </div>
